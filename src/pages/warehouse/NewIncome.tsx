...
import { collection, doc, updateDoc, serverTimestamp, writeBatch, addDoc } from 'firebase/firestore';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      for (const item of items) {
        ...
        // Добавляем запись в историю товара
      ...
      showErrorNotification('Ошибка при добавлении товаров');
    } finally {
